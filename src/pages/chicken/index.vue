<template>
    <div class="box">
        <div class="chickentitle">
            <van-row>
                <van-col span="9">
                    <div class="index_col1">
                        <img src="../../../static/tabs/shouye/tablogo.png" />
                    </div>
                </van-col>
        ...
        <div class="category">
            ...
            <scroll-view scroll-y class="categoryRight" >
                <div class="categoryimg">
                    <img src="../../../static/tabs/shouye/tabimg.png" />
                </div>
...
export default {
    ...
    onShow () {
        this.$wxhttp.post({
            ...
            console.log(e)
            this.chickens = e.data.data
            this.cates = e.data.cate
